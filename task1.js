...
const createProduct = (products) => new Promise(
    (resolve, reject) => {
        if(!products.id) {
            reject(new Error("Product id is required"));
        }
        products.name = products.name || "Unknown Product";
        products.price = products.price || 0;
        resolve(products);
    }
)

const searchProduct = (products) => new Promise(
    (resolve, reject) => {
...
const updateProduct = (id, data) => new Promise(
...
const deleteProduct = (id, data) => new Promise(
    async (resolve, reject) => {
        await delay(100);
